...
const pageValues = [
  ...
  "PASTE",
  "CLAIM WALLET",
  "By clicking this box, you agree that paying a one-time fee from your ordinal wallet helps verify ownership and supports the platform. You acknowledge that wallet verification may be required again if another user claims ownership of the same wallet address using this method.",
  "Owner of",
  "Inscriptions",
] as const;
        ...
        {isValidWalletAddress ? (
          <>
            ...
            <div className="flex w-full gap-3">
              ...
              <p className="text-left text-sm font-normal text-appYellow800 sm:text-base">
                {
                  translatedValues?.[
                    "By clicking this box, you agree that paying a one-time fee from your ordinal wallet helps verify ownership and supports the platform. You acknowledge that wallet verification may be required again if another user claims ownership of the same wallet address using this method."
                  ]
