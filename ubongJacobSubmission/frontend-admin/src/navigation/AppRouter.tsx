...
import PaymentsHistoryPage from "@/pages/dashboard/paymentsHistory/PaymentsHistoryPage";
import PaymentHistoryDetailsPage from "@/pages/dashboard/paymentsHistory/PaymentHistoryDetailsPage";
import PaymentsSummaryPage from "@/pages/dashboard/paymentsHistory/PaymentsSummaryPage";
  ...
  return (
    <Routes>
      ...
      <Route element={<RequireAuth />}>
        ...
        />
        <Route
          path={routes.PAYMENTS_HISTORY_PAGE}
          Component={PaymentsHistoryPage}
        />
        <Route
          path={routes.PAYMENTS_HISTORY_DETAILS_PAGE(":id")}
          Component={PaymentHistoryDetailsPage}
        />
        <Route
          path={routes.PAYMENTS_SUMMARY_PAGE}
