...
const pageValues = [
  ...
  "We have detected your verification fee and are currently awaiting its confirmation on the network. The verification will be done once the payment has received at least 1 confirmation on the network. You may proceed to your home page.",
] as const;
    ...
    <>
      ...
      <div className="mb-7 w-full rounded-2xl bg-appBlue160 p-4">
        ...
        <div className="flex items-center justify-center pb-5 pt-7">
          <Link
            className="w-full rounded-2xl bg-black py-4 text-white text-center text-sm font-bold shadow-appButtonInnerShadow2 transition-all duration-300 hover:bg-appBlue800 active:scale-95 disabled:cursor-not-allowed disabled:opacity-50 sm:text-base"
